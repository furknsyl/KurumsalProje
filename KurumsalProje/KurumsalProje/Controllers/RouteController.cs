...
namespace KurumsalProje.Controllers
{
    public class RouteController : Controller
    {
        ...
        {
            var firmalar = db.BSMGRBCEROT001.ToList();
        ...
        public ActionResult YeniKayıt()
        {
            ...
            return View(new BSMGRBCEROT001());
        }

        [HttpPost]
        public ActionResult YeniKayıt(BSMGRBCEROT001 p)
        {
            if (db.BSMGRBCEROT001.Any(x => x.COMCODE == p.COMCODE && x.DOCTYPE == p.DOCTYPE))
            {
                ModelState.AddModelError("", "Bu COMCODE ve DOCTYPE kombinasyonu zaten mevcut.");
                return View(p);
            }

            db.BSMGRBCEROT001.Add(p);
            db.SaveChanges();
        ...
        public ActionResult KayıtSil(string COMCODE)
        {
            ...
            var kayitbul = db.BSMGRBCEROT001.FirstOrDefault(k => k.COMCODE == COMCODE);
            ...
            db.BSMGRBCEROT001.Remove(kayitbul);  // Kaydı silme
        ...
        {
            var atolye = db.BSMGRBCEROT001.Find(COMCODE);
        ...
        public ActionResult KayıtGuncelle(string COMCODE)
        {
            ...
            var kayit = db.BSMGRBCEROT001.FirstOrDefault(k => k.COMCODE == COMCODE);
        ...
        public ActionResult KayıtGuncelle(BSMGRBCECCM001 model)
        {
            ...
            // COMCODE'ye göre kaydı bul
            var kayit = db.BSMGRBCEROT001.FirstOrDefault(k => k.COMCODE == model.COMCODE);

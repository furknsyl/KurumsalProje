...
namespace KurumsalProje.Controllers
{
    public class OperationTypeController : Controller
    {
        ...
        {
            var firmalar = db.BSMGRBCEOPR001.ToList();
        ...
        public ActionResult YeniKayıt()
        {
            ...
            return View(new BSMGRBCEOPR001());
        }

        [HttpPost]
        public ActionResult YeniKayıt(BSMGRBCEOPR001 p)
        {
            if (db.BSMGRBCEOPR001.Any(x => x.COMCODE == p.COMCODE && x.DOCTYPE == p.DOCTYPE))
            {
                ModelState.AddModelError("", "Bu COMCODE ve DOCTYPE kombinasyonu zaten mevcut.");
                return View(p);
            }

            db.BSMGRBCEOPR001.Add(p);
            db.SaveChanges();
        ...
        public ActionResult KayıtSil(string COMCODE)
        {
            ...
            var kayitbul = db.BSMGRBCEOPR001.FirstOrDefault(k => k.COMCODE == COMCODE);
            ...
            db.BSMGRBCEOPR001.Remove(kayitbul);  // Kaydı silme
        ...
        {
            var atolye = db.BSMGRBCEOPR001.Find(COMCODE);
        ...
        public ActionResult KayıtGuncelle(string COMCODE)
        {
            ...
            var kayit = db.BSMGRBCEOPR001.FirstOrDefault(k => k.COMCODE == COMCODE);
        ...
        [HttpPost]
        public ActionResult KayıtGuncelle(BSMGRBCEOPR001 model)
        {
            // Model doğrulama
            ...
            // COMCODE'ye göre kaydı bul
            var kayit = db.BSMGRBCEOPR001.FirstOrDefault(k => k.COMCODE == model.COMCODE);

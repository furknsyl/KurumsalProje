...
{
    public class BomTypeController : Controller
    {
        KKPBCEEntities db = new KKPBCEEntities();
        // GET: Default
        public ActionResult Index()
        {
            var firmalar = db.BSMGRBCEBOM001.ToList();
        ...
        public ActionResult YeniKayıt()
        {
            ...
            return View(new BSMGRBCEBOM001());
        }

        [HttpPost]
        public ActionResult YeniKayıt(BSMGRBCEBOM001 p)
        {
            if (db.BSMGRBCEBOM001.Any(x => x.COMCODE == p.COMCODE && x.DOCTYPE == p.DOCTYPE))
            {
                ModelState.AddModelError("", "Bu COMCODE ve DOCTYPE kombinasyonu zaten mevcut.");
                return View(p);
            }

            db.BSMGRBCEBOM001.Add(p);
            db.SaveChanges();
        ...
        public ActionResult KayıtSil(string COMCODE)
        {
            ...
            var kayitbul = db.BSMGRBCEBOM001.FirstOrDefault(k => k.COMCODE == COMCODE);
            ...
            db.BSMGRBCEBOM001.Remove(kayitbul);  // Kaydı silme
        ...
        {
            var atolye = db.BSMGRBCEBOM001.Find(COMCODE);
        ...
        public ActionResult KayıtGuncelle(string COMCODE)
        {
            ...
            var kayit = db.BSMGRBCEBOM001.FirstOrDefault(k => k.COMCODE == COMCODE);
        ...
        public ActionResult KayıtGuncelle(BSMGRBCECCM001 model)
        {
            ...
            // COMCODE'ye göre kaydı bul
            var kayit = db.BSMGRBCEBOM001.FirstOrDefault(k => k.COMCODE == model.COMCODE);

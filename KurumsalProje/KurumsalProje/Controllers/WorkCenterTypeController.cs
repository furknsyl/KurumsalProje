...
{
    public class WorkCenterTypeController : Controller
    {
        KKPBCEEntities db = new KKPBCEEntities();
        // GET: Default
        public ActionResult Index()
        {
            var firmalar = db.BSMGRBCEWCM001.ToList();
        ...
        public ActionResult YeniKayıt()
        {
            ...
            return View(new BSMGRBCEWCM001());
        }

        [HttpPost]
        public ActionResult YeniKayıt(BSMGRBCEWCM001 p)
        {
            if (db.BSMGRBCEWCM001.Any(x => x.COMCODE == p.COMCODE && x.DOCTYPE == p.DOCTYPE))
            {
                ModelState.AddModelError("", "Bu COMCODE ve DOCTYPE kombinasyonu zaten mevcut.");
                return View(p);
            }

            db.BSMGRBCEWCM001.Add(p);
            db.SaveChanges();
        ...
        public ActionResult KayıtSil(string COMCODE)
        {
            ...
            var kayitbul = db.BSMGRBCEWCM001.FirstOrDefault(k => k.COMCODE == COMCODE);
            ...
            db.BSMGRBCEWCM001.Remove(kayitbul);  // Kaydı silme
        ...
        {
            var atolye = db.BSMGRBCEWCM001.Find(COMCODE);
        ...
        public ActionResult KayıtGuncelle(string COMCODE)
        {
            ...
            var kayit = db.BSMGRBCEWCM001.FirstOrDefault(k => k.COMCODE == COMCODE);
        ...
        public ActionResult KayıtGuncelle(BSMGRBCECCM001 model)
        {
            ...
            // COMCODE'ye göre kaydı bul
            var kayit = db.BSMGRBCEWCM001.FirstOrDefault(k => k.COMCODE == model.COMCODE);
